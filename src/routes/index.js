...
const EstateAppraisals = lazy(() =>
  import("../pages/services/EstateAppraisals")
);
const JewelryInsurance = lazy(() =>
  import("../pages/services/JewelryInsurance")
);
const JewelryPurchase = lazy(() => import("../pages/services/JewelryPurchase"));
const LitigationSupport = lazy(() =>
  import("../pages/services/LitigationSupport")
);
const MissingJewelry = lazy(() => import("../pages/services/MissingJewelry"));
const PrePurchase = lazy(() => import("../pages/services/PrePurchase"));
const ReportVerification = lazy(() =>
  import("../pages/services/ReportVerification")
);
