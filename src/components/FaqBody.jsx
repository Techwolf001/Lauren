          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                open ? 'border-none mb-3' : ""} flex w-full bg-white px-4 py-6 text-left text-xl my-7 font-semibold text-black border-2 focus:outline-none "`}
                >
                <PlusIcon 
                  className={`${
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>What makes your appraisals better than other appraisers?</span>
          ...
          {({ open }) => (
            <>
              ...
              <Transition
                ...
                >
              <Disclosure.Panel className="px-4 pb-2 pt-4 text-[17px] text-gray-900">
              Each appointment takes 30 to 45 minutes for me to take my notes and pictures of your item while you wait and watch. Your official written appraisal will be ready in 5 to 7 business days. I email your appraisal to you and then put your original paper appraisal in the mail to your address. You always leave our appointment with your jewellery and I use my notes and pictures to make your appraisal.
              </Disclosure.Panel>
              </Transition>
            </>
          )}
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>Once I give you my jewelry, how long does it takes to receive payment?</span>
          ...
          {({ open }) => (
            <>
              ...
              <Transition
                ...
                >
              <Disclosure.Panel className="px-4 pb-2 pt-4 text-[17px] text-gray-900">
                Your GIA or other certificates if you have it and a form of identification. We will also ask you to sign a document confirming that you are the owner of the item.
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>Would your company un-mount my diamonds for me, or do I have to un-mount them myself?</span>
              ...
              <Transition
                ...
                >
              <Disclosure.Panel className="px-4 pb-2 pt-4 text-[17px] text-gray-900">
              If necessary, our company may un-mount the diamonds for you, but only with your permission.
              </Disclosure.Panel>
              </Transition>
            </>
          )}
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>When I bring my jewelry, will it be examined in front of me?</span>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>Do I need to make an appointment, or do I just walk in?</span>
              ...
              We highly encourage making an appointment prior to coming in: info@laurenangelogems.com however we do accept walk-ins.
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>Do I need to come in or can I email or fax over a picture of the jewelry I want to sell?</span>
              ...
              <Transition
                ...
                >
              <Disclosure.Panel className="px-4 pb-2 pt-4 text-[17px] text-gray-900">
              You may send us an email or a fax, but if we are interested, the piece must be examined in person to ensure you are offered the best price.
              </Disclosure.Panel>
              </Transition>
            </>
          )}
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>I'm not sure if I want to sell my jewelry, can I come in for a Consultation?</span>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>What is the process that takes place once I decide I want to sell the jewelry to your company?</span>
          ...
          {({ open }) => (
            <>
              <Disclosure.Button className={`${
                ...
                />
                <span>What is the Difference Between Fair Market Value and Marketable Cash Value?</span>
              ...
              <div className="faq-body">
				<p className="">
                    ...
                    &nbsp;If you are a willing seller and selling your jewelry by yourself and not paying any commissions, advertising costs, etc. then the money you sell it for is called the Fair Market Value.
                </p>
                <p className="">
                    <strong>
                        <em>Marketable Cash Value:</em>
                    </strong>
                    &nbsp;If you need help selling the jewelry items you would then be paying a commission or fee to someone who has experience and contacts in selling the types of jewelry you have for sale. Your take home price is the selling price less any commission and advertising fees that have been incurred.
                </p>
					</div>
              </Disclosure.Panel>
              </Transition>
