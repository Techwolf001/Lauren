          ...
          <div className="block bg-[url('/banner1.jpeg')] relative bg-cover bg-no-repeat bg-center z-10 overflow-visible px-0 ">
            <div className="com:mx-40 tv:mx-40 cin:mx-40 mx-4 w-full com:px-4 tv:px-4 cin:px-4 px-2">
              <div className="pt-[215px] pb-[180px] sm:pb-[100px] px-0 sm:mr-40">
                <div>
                  <h1 className="com:text-[80px] tv:text-[80px] cin:text-[80px] text-[60px] sm:text-[40px] relative sm:-top-24 w-sm:text-[40px] w-[40%] sm:w-[120%] text-white com:py-5 tv:py-5  px-0 font-semibold opacity-100 translate-y-0 transition-all ease-in duration-[1500ms] delay-1000 leading-[1.25]">
