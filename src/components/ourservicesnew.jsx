          ...
          {ServiceNames.map((ServiceNames) => {
            ...
            return (
              <div className="flex flex-wrap flex-row cus1:-mx-4">
                <div className=" grow-0 shrink-0 mcom:basis-1/2 cus1:basis-2/6 relative mx-4 min-h-[1px] w-full px-4 hover:-translate-y-6 transition duration-1000 ease-in-out">
                  <Link to={LinkTo}>
